...
**Terraform IaC**와 **GitHub Actions CI/CD**로 인프라·배포를 자동화하고, **로그·패킷 기반 트러블슈팅**과 **Runbook**으로 신뢰성을 높입니다.  
또한 **Python 데이터 처리**과 **ML/CV 기능**을 **API로 서비스화**하여, 운영 관점에서 안정적으로 제공하는 **엔드투엔드 흐름**을 지향합니다.

## 🚀 Projects
| Project | Description | Role | Period |
|---|---|---|---|
| 🤖 [Postura](https://github.com/TABA-postura) | 웹캠 기반 실시간 자세 교정 웹 서비스 | AI Inference API (FastAPI) · CI/CD | 2025.10-12 |
| ☁️ [Cloud Ops Lab](https://github.com/yejin1029/Cloud_Ops_Lab) | Terraform 기반 Nginx 배포 랩 | Terraform IaC · user_data · Verify/Destroy | 2026.01 |
| ✅ [Nginx Runbook](https://github.com/yejin1029/Nginx_troubleshooting) | Nginx 접속 불가 트러블슈팅 Runbook | Incident reproduction · Runbook · tcpdump | 2026.01 |
